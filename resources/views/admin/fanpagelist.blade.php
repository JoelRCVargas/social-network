                ...
                "columns": [
                    ...
                    { data: "cover",
                        render:function(data,type,full,meta){
                            return "<div class='container-img' style='max-width: 100px;'><img src={{URL::to('/')}}/assets/fanpage/"+data+" width='70' class='thumbnail'><div/>";
                        },
                        roderable:false
                    },
                    { data: "profile",
                    ...
                    { data: "id",
                        render:function(data,type,full,meta){
                            return "<a class='btn btn-primary' href='{{URL::to('/')}}/admin/publication/fanpage?id="+data+"'>Publicar<a/>";
                        },
                        roderable:false
                    }
                ],
